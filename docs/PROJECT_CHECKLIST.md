...
**Repository name:** `sales-performance-revenue-growth-dashboard`

**One-line description:** Power BI dashboard tracking sales performance, revenue growth, and target achievement across regions, product categories, and sales executives.
...
3. In **Repository name**, type `sales-performance-revenue-growth-dashboard`.
...
9. Drag and drop: `README.md`, `Sales_Performance_Dataset.xlsx`, `Raw_Dataset_Before_Cleaning.xlsx`, the entire `docs` folder, the `screenshots` folder (once you have images), and your `.pbix` file once it's built.
10. Scroll down, type a commit message such as "Initial commit: Sales Performance & Revenue Growth Dashboard".
11. Click **Commit changes**.

## Files to upload to GitHub

- [ ] `Sales-Performance-Revenue-Growth-Dashboard.pbix` (save from Power BI Desktop after building — File → Save As)
- [ ] `Sales_Performance_Dataset.xlsx` (clean dataset — already included)
...
- [ ] All five slicers (Region, Product Category, Sales Channel, Sales Executive, Month) are tested — filtering by each one updates every visual correctly
